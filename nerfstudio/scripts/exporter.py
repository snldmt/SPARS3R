...
from nerfstudio.exporter.exporter_utils import collect_camera_poses, generate_point_cloud, get_mesh_from_filename, generate_point_cloud_per_image_with_mask
...
class ExportPointCloud(Exporter):
    ...
    save_name: str = "point_cloud.ply"
    """Name of the saved point cloud file."""
    ...
    def main(self) -> None:
        ...
        o3d.t.io.write_point_cloud(str(self.output_dir / self.save_name), tpcd)
