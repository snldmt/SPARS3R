...
class RenderInterpolated(BaseRender):
    ...
    interpolation_method: Literal["interval", "interval_ext", "wildgs_ext","fsgs_ext"] = "interval"
    ...
    def main(self) -> None:
        ...
        if self.interpolation_steps < 100:
            seconds = self.interpolation_steps * len(cameras) / self.frame_rate
        else:
            seconds = self.interpolation_steps / self.frame_rate
        ...
        for split in self.split.split("+"):
            ...
            with Progress(
                ...
                for camera_idx, (camera, batch) in enumerate(progress.track(dataloader, total=len(dataset))):
                    ...
                    rendered_output_names = ['gt-rgb', 'rgb', 'depth', 'accumulation']
